...
public class Test {	
	...
	public static void main(String[] args) {
		...
		Player player1 = new Player(PlayerID.ONE);
		Player player2 = new Player(PlayerID.TWO);
